...
<%@page import="com.uit.new_recycle.service.VnPayService"%>
...
<%@page import="java.util.HashMap"%><%@ page import="java.io.PrintWriter"%>
 ...
 <%
     ...
     String signValue = com.uit.new_recycle.service.VnPayService.(fields);
